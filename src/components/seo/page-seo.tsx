...
export function generateProfileMetadata(): Metadata {
  return generateMetadata({
    ...
    description:
      "Manage your EduNova profile, track your course progress, view certificates, and customize your learning experience.",
    canonical: "/my-profile",
    openGraph: {
      type: "profile",
      title: "My Profile - Manage Your Learning Journey",
      description:
        "Manage your EduNova profile and track your course progress.",
    },
...
export function generateSearchMetadata(query?: string): Metadata {
  const title = query
    ? `Search Results for "${query}" | EduNova`
    : "Search Courses and Blogs | EduNova";
...
export function generateCategoryMetadata(category: {
  ...
  const title = `${category.name} Courses | EduNova`;
  const description =
    category.description ||
    `Explore ${
      category.name
    } courses on EduNova. Learn from expert instructors and advance your skills in ${category.name.toLowerCase()}.`;
