			...
			<Card className="max-w-md w-full">
				<CardContent className="p-6 sm:p-8 text-center">
					<div className="mb-4 sm:mb-6">
						<PartyPopper className="w-12 h-12 sm:w-16 sm:h-16 text-primary mx-auto mb-3 sm:mb-4 animate-bounce" />
						...
						<div className="bg-primary/10 border border-primary/30 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
