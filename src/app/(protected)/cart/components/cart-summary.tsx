...
const CartSummary = ({ cart }: CartSummaryProps) => {
  ...
  return (
    <div className="bg-card rounded-lg sm:rounded-xl border border-border shadow-md sm:shadow-lg lg:sticky lg:top-24">
      <div className="p-3 sm:p-4 space-y-3 sm:space-y-4">
        ...
        <div className="space-y-2 sm:space-y-3">
          <h4 className="font-semibold text-foreground text-[10px] sm:text-xs">
                ...
                <Button
                  ...
                  className={`p-2 sm:p-3 h-auto min-h-[70px] sm:min-h-[80px] flex-col transition-all duration-200 relative group ${
                    isSelected
                      ...
                      : "bg-card hover:bg-background/60 border-border hover:border-primary/40 hover:shadow-sm"
                  }`}
                    ...
                    <div
                      className={`p-1.5 sm:p-2 rounded-lg transition-all duration-200 ${
                        isSelected
                          ...
                          : "bg-background/70 group-hover:bg-background"
                      }`}
                    >
                      <Icon
